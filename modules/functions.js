module.exports = (client) => {
    ...
    */
    ...
    // getSubmissions does the same but for the Submissions portion
    client.getSubmissions = (guild, user) => {
        client.submissions.ensure("default", defaultSubmission);
        if (!guild) return client.submissions.get("default");
        const submissions = client.submissions.get(`${guild.id}-${user.id}`) || {};
        return ({
            ...client.submissions.get("default"),
            ...submissions
        });
    };
    ...
    //sqlite entry.
    client.refreshDefaultSettings = () => {
        client.settings.delete("default");
        client.settings.ensure("default", defaultSettings);
    }

    client.refreshDefaultSubmission = () => {
        client.submissions.delete("default");
        client.submissions.ensure("default", defaultSubmission);
    }
